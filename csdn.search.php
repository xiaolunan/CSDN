<?php
    ...
    $key=$_GET['key'];
    $sqlselect="select * from csdntest WHERE title like '%$key%' ORDER by datetime desc";
...
<div id="wrapper">
    ...
    <div id="header">
        ...
        <div id="menu">
            <ul>
                <li class="active"><a href="csdn.list.php">文章</a></li>
        ...
        if(empty($data)){
            ...
            foreach($data as $value){
                ...
                <div class="post">
                    ...
                    <div class="meta">
                        <p class="links"><a href="csdn.show.php?id=<?php echo $value['id']?>" class="more">查看详细</a>&nbsp;&nbsp;&raquo;&nbsp;&nbsp;</p>
                    </div>
                </div>
                <?php
            }
    ...
    <div id="sidebar">
        <ul>
            <li id="search">
                ...
                <form method="get" action="csdn.search.php">
                    <fieldset>
